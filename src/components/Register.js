                ...
                <div className="popup__container">
                    <form  className="popup__card_theme_dark">
                        ...
                        <div className="popup__field">
                            <input ref={emailInput} defaultValue="" className="popup__row_theme_dark" name="name" type="email" minLength="2" maxLength="40" required id="Email" placeholder="Email"/>
                        ...
                        <button onClick={handleSubmit} className='popup__btn_theme_dark' type="button">Зарегистрироваться</button>
